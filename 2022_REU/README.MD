...
|Philippines|27-Jun        |3   |Organize a literature cited page (at least 10 primary literature papers including the 3 provided in this page) into a properly formatted database (EndNote, Mendeley, etc).  Mentors can help you if you're not already familiar with reference databases. You will then use these references to write  a <250 word abstract and an introduction for your report (a minimum of 1 page but can be longer).  The introduction should lay out relevant literature and justification for your work and include a concise statement of the research goals |Complete Citation Database        |
...
|US         |18-Jul        |6   |Travel back to US for some. Continue working on the data analysis of your species.                                                                                                                                                                                                                                                                                                                                                                                                                             |Draft Tables and Figures           |
